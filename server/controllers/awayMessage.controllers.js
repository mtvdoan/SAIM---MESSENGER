...
module.exports = {
        ...
        AwayMessage.find()
            ...
            .catch((err) =>
                res
                    ...
                    .json({
                        message:
                            "Something went wrong while trying to view all awayMessages",
                        error: err,
                    })
            );
    },
    ...
    findOneAwayMessage: (req, res) => {
        AwayMessage.findById(req.params.id)
            ...
            .catch((err) =>
                res
                    ...
                    .json({
                        message:
                            "Something went wrong while trying to find details of a awayMessage",
                        error: err,
                    })
            );
    },
    createAwayMessage: (req, res) => {
        ...
        AwayMessage.create(req.body)
            .then((newAwayMessage) => res.json(newAwayMessage))
            .catch((err) =>
                res
                    .status(400)
                    .json({
                        message: "Something went wrong while trying to create",
                        error: err,
                    })
            );
    ...
    updateAwayMessage: (req, res) => {
        AwayMessage.findByIdAndUpdate(req.params.id, req.body, {
            new: true,
            runValidators: true,
        })
    ...
    deleteAwayMessage: (req, res) => {
        AwayMessage.findByIdAndDelete(req.params.id)
